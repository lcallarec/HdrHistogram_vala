namespace HdrHistogram { 
    ...
    public class Int32Histogram : AbstractHistogram {
        ...
        public static Int32Histogram decode(string histogram) throws HdrError {
            return _decode(typeof(Int32Histogram), histogram) as Int32Histogram;
        }

        public static Int32Histogram decode_compressed(string histogram) throws HdrError {
            return _decode_compressed(typeof(Int32Histogram), histogram) as Int32Histogram;
        }

        public static Int32Histogram decode_from_byte_buffer(ByteArray buffer) throws HdrError {
            return _decode_from_byte_buffer(typeof(Int32Histogram), buffer) as Int32Histogram;
        }

        public static Int32Histogram decode_from_compressed_byte_buffer(ByteArray compressed_buffer) throws HdrError {
            return _decode_from_compressed_byte_buffer(typeof(Int32Histogram), compressed_buffer) as Int32Histogram;
        }
        ...
        internal override void add_to_count_at_index(int index, int64 value) throws HdrError {
            ...
            counts[normalized_index] = (uint32) newCount;
        }
