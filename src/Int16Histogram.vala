namespace HdrHistogram { 
    ...
    public class Int16Histogram : AbstractHistogram {
        private uint16[] counts;
        private int normalizing_index_offset;
        private int64 total_count;

        public Int16Histogram(int64 lowest_discernible_value, int64 highest_trackable_value, int8 number_of_significant_value_digits) {
         ...
         */
        public Int16Histogram.from_source(AbstractHistogram source, bool allocate_counts_array = true) {
            base.from_source(source);
            if (allocate_counts_array) {
                counts = new uint16[counts_array_length];
            }
        ...
        public static Int16Histogram decode(string histogram) throws HdrError {
            return _decode(typeof(Int16Histogram), histogram) as Int16Histogram;
        }

        public static Int16Histogram decode_compressed(string histogram) throws HdrError {
            return _decode_compressed(typeof(Int16Histogram), histogram) as Int16Histogram;
        }

        public static Int16Histogram decode_from_byte_buffer(ByteArray buffer) throws HdrError {
            return _decode_from_byte_buffer(typeof(Int16Histogram), buffer) as Int16Histogram;
        }

        public static Int16Histogram decode_from_compressed_byte_buffer(ByteArray compressed_buffer) throws HdrError {
        ...
        internal override void clear_counts() {
            Arrays.Int16.fill((int16[]) counts, 0, counts_array_length, 0);
            total_count = 0;
        }
        ...
        internal override void resize(int64 new_highest_trackable_value) throws HdrError {
            ...
            counts = (uint16[]) Arrays.Int16.copy((int16[]) counts, counts_array_length);
            ...
            if (old_normalized_zero_index != 0) {
                ...
                Arrays.Int16.array_copy((int16[]) counts, old_normalized_zero_index, (int16[]) counts, new_normalized_zero_index, length_to_copy);
                Arrays.Int16.fill((int16[]) counts, old_normalized_zero_index, new_normalized_zero_index, 0);
            }
        }
        ...
        internal override void set_count_at_index(int index, int64 value) throws HdrError {
            counts[normalize_index(index, normalizing_index_offset, counts_array_length)] = (uint16) value;
        }
